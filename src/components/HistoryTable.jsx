...
const HistoryTable = ({ currentStudent }) => {
        ...
        const unsubscribeLogs = onValue(logsRef, (snapshot) => {
            ...
            if (data) {
                const logsArray = Object.values(data)
                    .filter(log => log.student_id === currentStudent.id) // Filter for current student
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {loading ? (
                            ...
                            <tr><td colSpan="2" className="p-4 text-center text-gray-500">No history available</td></tr>
                        ) : (
                            logs.map((log, index) => {
