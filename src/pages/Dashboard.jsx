        ...
        <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-500 italic text-lg">
                    Welcome back, <span className="font-semibold text-gray-900">{currentStudent?.name}</span>
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[calc(100vh-200px)] min-h-[600px]">
                ...
                <div className="lg:col-span-1 flex flex-col gap-6 h-full">
                    <div className="flex-1 min-h-[300px] bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                        <LiveStudentList currentStudent={currentStudent} />
                    </div>
                    <div className="flex-1 min-h-[300px] bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                        <HistoryTable currentStudent={currentStudent} />
                    </div>
                </div>
            </div>
        </div>
